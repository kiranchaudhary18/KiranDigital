...
const Hero = () => {
  ...
  const handleDownloadResume = () => {
    window.open(`https://drive.google.com/file/d/1ITiSraMnhAJnCFrVi64WO4LM66sIylx0/view?usp=drive_link&v=${Date.now()}`, '_blank')
  }
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 animate-fade-in">
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-textPrimary">300+</div>
